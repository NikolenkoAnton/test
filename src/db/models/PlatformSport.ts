...
@Table({ timestamps: true, tableName: 'bb_platform_sport', freezeTableName: true, underscored: true })
export default class PlatformSport extends Model {
  @PrimaryKey
  @AutoIncrement
